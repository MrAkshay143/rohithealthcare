      ...
      <section className="bg-white border-b border-gray-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-gray-100">
            {stats.map((s) => (
              <div key={s.label} className="flex flex-col items-center justify-center py-6 sm:py-8 px-3 sm:px-4 text-center group hover:bg-[#015851]/5 transition-colors">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl overflow-hidden bg-gray-900 shadow-xl">
            <div className="grid md:grid-cols-2">
              ...
              <div className="min-h-52 md:min-h-auto bg-cover bg-center"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 justify-items-center">
              {doctors.slice(0, 4).map((doc, i) => (
                <div key={doc.id} className={`w-full max-w-80 ${i === 0 ? 'block' : i === 1 ? 'hidden sm:block' : i === 2 ? 'hidden md:block' : 'hidden lg:block'}`}>
