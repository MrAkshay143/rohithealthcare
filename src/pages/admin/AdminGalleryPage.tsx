    ...
    <div>
      ...
      <div className="flex flex-wrap items-center gap-4 mb-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 mt-0.5">Manage clinic photo gallery displayed on the website.</p>
        </div>
      ...
      {photos.length === 0 && <p className="text-sm text-gray-400 mt-4">No photos yet. Add the first one above.</p>}
    </div>
  );
}
