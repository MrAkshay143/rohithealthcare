        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            {ctaDesktop && (
              <a
                href={`tel:+${phone}`}
                className="hidden lg:flex items-center justify-center gap-2 rounded-full bg-brand-green-dark px-5 lg:px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-brand-green-dark/20 hover:bg-[#2e407d] transition-all hover:scale-105"
              >
        ...
        <div className="px-4 py-6 space-y-1 shadow-inner">
          ...
          {ctaMobile && (
            <div className="pt-4 mt-2 border-t border-gray-100">
              <a
                href={`tel:+${phone}`}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-green-dark px-4 py-3.5 text-base font-bold text-white shadow-md shadow-brand-green-dark/20 hover:bg-[#2e407d]"
              >
