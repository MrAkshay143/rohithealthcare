    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="p-4 sm:p-7 space-y-5">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 rounded-xl bg-brand-green-dark py-4 text-sm font-bold text-white shadow-lg shadow-brand-green-dark/20 hover:bg-[#2e407d] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {isSubmitting ? (
